...
const DoctorDashboards = () => {
  ...
  return dashData && (
    ...
    <div className='container d-flex gap-3 mt-2 flex-wrap'>
              <div className='d-flex gap-2 border bg-light border-1 rounded p-2 mb-5 border-secondary '>
                <div> <img src={assets.earning_icon} alt="" /></div>
...

  {
    ...
    <div key={index} className="d-flex align-items-center justify-content-between border  p-3 mb-2 shadow-sm rounded">
      ...
      {/* Doctor Image */}
      <img src={item.userData.image} alt="Doctor" className="rounded-circle me-3" style={{ width: '50px', height: '50px' }} />

      {/* Doctor Info & Date */}
      <div className="flex-grow-1">
        <p className="fw-bold mb-2">{item.userData.name}</p>
